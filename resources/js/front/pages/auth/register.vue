                ...
                <div class="auth-page-wrap">
                    <div class="auth-box card border-0 p-sm-4 shadow rounded-4">
                        <form @submit.prevent="register()" class="auth-form p-4" autocomplete="off">
                            <div class="box-title display-6 mb-4 text-center"><span>B</span>ookmark <span>A</span>pp
                            </div>
                            <div class="text-center fs-3 text-dark mb-4">Register here</div>
                            ...
                            <div class="form-group ms-2">
                                ...
                                <span>
                                    ...
                                    <polyline points="1.5 6 4.5 9 10.5 1"></polyline>
                                        ...
                                        <span class="text-dark">Show Password</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-theme w-100">Sign Up
                                    <span class="ms-2" v-if="registerLoading === false"><img
